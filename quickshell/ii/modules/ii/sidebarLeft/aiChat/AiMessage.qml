...
Rectangle {
    ...
    readonly property string attachedFilePath: root.messageData && root.messageData.localFilePath ? root.messageData.localFilePath : ""
    readonly property bool messageDone: root.messageData && typeof root.messageData.done !== "undefined" ? root.messageData.done : true
    readonly property string messageContent: root.messageData && root.messageData.content ? root.messageData.content : ""
    property list<var> messageBlocks: StringUtils.splitMarkdownBlocks(root.messageContent)
    ...
    ColumnLayout { // Main layout of the whole thing
        ...
        Loader {
            Layout.fillWidth: true
            active: root.attachedFilePath.length > 0
            sourceComponent: AttachedFileIndicator {
                filePath: root.attachedFilePath
                canRemove: false
            }
        }
        ...
        ColumnLayout { // Message content
            ...
            Item {
                ...
                FadeLoader {
                    ...
                    anchors.centerIn: parent
                    shown: root.messageBlocks.length < 1 && !root.messageDone
            ...
            Repeater {
                ...
                delegate: DelegateChooser {
                    ...
                    DelegateChoice { roleValue: "text"; MessageTextBlock {
                        ...
                        forceDisableChunkSplitting: root.messageContent.includes("```")
                    } }
                }
            }
        }
